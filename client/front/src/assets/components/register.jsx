...
const register = () => {
  ...
  return (
    ...
    >
      <h1 className="text-2xl font-bold text-center mb-6">Registro Empleado</h1>
      ...
      <div className="mb-4">
        <label className="block text-gray-700 mb-1" htmlFor="edad">
          Edad
        </label>
        <input
          className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        {errors.apellido && (
          <div className="text-red-600 text-sm mt-1">
            {errors.edad?.type == "max" && <span> Mayor de edad</span>}
            {errors.edad?.type == "min" && <span> Menor de edad </span>}
        ...
        {errors.telefono && (
          <div className="text-red-600 text-sm mt-1">
            {errors.telefono?.type == "required" && (
              <span> El telefono es requierido </span>
            )}
          </div>
        )}
      </div>
      ...
      <div className="mb-4">
        <label className="block text-gray-700 mb-1" htmlFor="cargo">
          Cargo
        </label>
        <select
          className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        {errors.cargo?.type == "required" && (
          <span> El cargo es requerido </span>
        )}
      </div>
      )}
      </div>
