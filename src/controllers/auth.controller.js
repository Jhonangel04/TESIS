...
const register = async (req, res) => {
  try {
    ...
    const createUser = await client.query('INSERT INTO user (name, lastname, identification, email, password, role_id, date_of_birth) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *', [name, lastname, identification, email, password, RoleID ,date_of_birth]);
